...
#
# vpk180-1x100G.tcl: Tcl script for re-creating project 'mrmac_0_ex'
#
# Generated by Vivado on Tue Feb 11 17:50:36 PST 2025
...
#
# 1. This project restoration tcl script (vpk180-1x100G.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/group/techsup/ajayad/cases/current/00588809/0211-100g-caui-1-clk-fixed/mrmac_0_ex/imports/mrmac_0_axis_stream_mux.sv"
#    "/group/techsup/ajayad/cases/current/00588809/0211-100g-caui-1-clk-fixed/mrmac_0_ex/imports/mrmac_0_exdes.sv"
#    "/group/techsup/ajayad/cases/current/00588809/0211-100g-caui-1-clk-fixed/mrmac_0_ex/imports/mrmac_0_gen_mon_all.sv"
#    "/group/techsup/ajayad/cases/current/00588809/0211-100g-caui-1-clk-fixed/mrmac_0_ex/imports/mrmac_0_gen_mon_support.sv"
#    "/group/techsup/ajayad/cases/current/00588809/0211-100g-caui-1-clk-fixed/mrmac_0_ex/imports/mrmac_0_exdes_imp_top.sv"
#    "/group/techsup/ajayad/cases/current/00588809/0211-100g-caui-1-clk-fixed/mrmac_0_ex/mrmac_0_ex.srcs/sources_1/ip/mrmac_0_axis_clk_wiz_0/mrmac_0_axis_clk_wiz_0.xci"
#    "/group/techsup/ajayad/cases/current/00588809/0211-100g-caui-1-clk-fixed/mrmac_0_ex/imports/mrmac_0_example_top.xdc"
#    "/group/techsup/ajayad/cases/current/00588809/0211-100g-caui-1-clk-fixed/mrmac_0_ex/imports/mrmac_0_exdes_tb.v"
#
...
set script_file "vpk180-1x100G.tcl"
...
proc cr_bd_mrmac_0_cips { parentCell } {
  ...
  connect_bd_net -net Net  [get_bd_pins axi_gpio_prbs_ctl/gpio_io_o] \
  ...
  connect_bd_net -net axi_gpio_debug_gpio_io_o  [get_bd_pins axi_gpio_debug/gpio_io_o] \
  [get_bd_pins xlslice_gt_reset_rx_datapath/Din] \
  [get_bd_pins xlslice_gt_reset_tx_datapath/Din] \
  [get_bd_pins xlslice_gt_txpostcursor/Din] \
  [get_bd_pins xlslice_gt_txprecursor/Din]
  connect_bd_net -net axi_gpio_gt_prbs_comm_ctl_gpio_io_o  [get_bd_pins axi_gpio_gt_prbs_comm_ctl/gpio_io_o] \
  [get_bd_pins xlslice_gt_reset/Din] \
  [get_bd_pins xlslice_line_rate/Din] \
  [get_bd_pins xlslice_gt_loopback/Din] \
  [get_bd_pins xlslice_gt_txmaincursor/Din] \
  [get_bd_pins xlslice_gt_rxcdrhold/Din] \
  [get_bd_pins xlslice_top_ctl_mux/Din]
  connect_bd_net -net axi_gpio_prbs_ctl_gpio2_io_o  [get_bd_pins axi_gpio_prbs_ctl/gpio2_io_o] \
  [get_bd_pins xlslice_10/Din] \
  [get_bd_pins xlslice_12/Din] \
  [get_bd_pins xlslice_13/Din] \
  [get_bd_pins xlslice_14/Din] \
  [get_bd_pins xlslice_16/Din] \
  [get_bd_pins xlslice_17/Din] \
  [get_bd_pins xlslice_18/Din] \
  [get_bd_pins xlslice_19/Din]
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn  [get_bd_pins proc_sys_reset_0/interconnect_aresetn] \
  [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net stat_mst_reset_done_1  [get_bd_ports stat_mst_reset_done] \
  [get_bd_pins axi_gpio_gt_prbs_comm_ctl/gpio2_io_i]
  connect_bd_net -net versal_cips_0_pl0_ref_clk  [get_bd_pins versal_cips_0/pl0_ref_clk] \
  [get_bd_ports pl0_ref_clk_0] \
  [get_bd_pins axi_gpio_gt_prbs_comm_ctl/s_axi_aclk] \
  [get_bd_pins axi_gpio_prbs_ctl/s_axi_aclk] \
  ...
  [get_bd_pins axi_gpio_gt_prbs_comm_ctl/s_axi_aresetn] \
  [get_bd_pins axi_gpio_prbs_ctl/s_axi_aresetn] \
  ...
  [get_bd_ports c0_trig_in]
  connect_bd_net -net xlslice_10_Dout  [get_bd_pins xlslice_10/Dout] \
  [get_bd_ports c2_trig_in]
  connect_bd_net -net xlslice_12_Dout  [get_bd_pins xlslice_12/Dout] \
  [get_bd_ports c2_ten_gb_mode]
  connect_bd_net -net xlslice_13_Dout  [get_bd_pins xlslice_13/Dout] \
  [get_bd_ports c2_number_of_segments]
  connect_bd_net -net xlslice_14_Dout  [get_bd_pins xlslice_14/Dout] \
  [get_bd_ports c2_top_ctl_data_rate]
  connect_bd_net -net xlslice_16_Dout  [get_bd_pins xlslice_16/Dout] \
  [get_bd_ports c3_ten_gb_mode]
  connect_bd_net -net xlslice_17_Dout  [get_bd_pins xlslice_17/Dout] \
  [get_bd_ports c3_number_of_segments]
  connect_bd_net -net xlslice_18_Dout  [get_bd_pins xlslice_18/Dout] \
  [get_bd_ports c3_top_ctl_data_rate]
  connect_bd_net -net xlslice_19_Dout  [get_bd_pins xlslice_19/Dout] \
  [get_bd_ports c3_trig_in]
  connect_bd_net -net xlslice_2_Dout  [get_bd_pins xlslice_2/Dout] \
  [get_bd_ports c0_ten_gb_mode]
  connect_bd_net -net xlslice_3_Dout  [get_bd_pins xlslice_3/Dout] \
  [get_bd_ports c0_number_of_segments]
  connect_bd_net -net xlslice_4_Dout  [get_bd_pins xlslice_4/Dout] \
  [get_bd_ports c0_top_ctl_data_rate]
  connect_bd_net -net xlslice_5_Dout  [get_bd_pins xlslice_5/Dout] \
  [get_bd_ports c1_trig_in]
  connect_bd_net -net xlslice_7_Dout  [get_bd_pins xlslice_7/Dout] \
  [get_bd_ports c1_ten_gb_mode]
  connect_bd_net -net xlslice_8_Dout  [get_bd_pins xlslice_8/Dout] \
  [get_bd_ports c1_number_of_segments]
  connect_bd_net -net xlslice_9_Dout  [get_bd_pins xlslice_9/Dout] \
  [get_bd_ports c1_top_ctl_data_rate]
  ...
  connect_bd_net -net xlslice_gt_reset_rx_datapath_Dout  [get_bd_pins xlslice_gt_reset_rx_datapath/Dout] \
  [get_bd_ports gt_reset_rx_datapath_in]
  connect_bd_net -net xlslice_gt_reset_tx_datapath_Dout  [get_bd_pins xlslice_gt_reset_tx_datapath/Dout] \
  ...
  connect_bd_net -net xlslice_line_rate_Dout  [get_bd_pins xlslice_line_rate/Dout] \
  [get_bd_ports gt_line_rate]
  connect_bd_net -net xlslice_top_ctl_mux_Dout  [get_bd_pins xlslice_top_ctl_mux/Dout] \
  [get_bd_ports c0_top_ctl_muxes]
...
proc create_hier_cell_mrmac_0_gt_wrapper { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 31 -to 0 gpo_0
  ...
  set_property -dict [list \
    ...
    CONFIG.CHANNEL_ORDERING {/mrmac_0_core/gtm_tx_serdes_interface_0 mrmac_0_exdes_support_mrmac_0_core_0_0./gt_quad_base/TX0_GT_IP_Interface.0 /mrmac_0_core/gtm_tx_serdes_interface_1 mrmac_0_exdes_support_mrmac_0_core_0_0./gt_quad_base/TX1_GT_IP_Interface.1\
/mrmac_0_core/gtm_rx_serdes_interface_0 mrmac_0_exdes_support_mrmac_0_core_0_0./gt_quad_base/RX0_GT_IP_Interface.0 /mrmac_0_core/gtm_rx_serdes_interface_1 mrmac_0_exdes_support_mrmac_0_core_0_0./gt_quad_base/RX1_GT_IP_Interface.1}\
\
    CONFIG.GT_TYPE {GTM} \
    CONFIG.PORTS_INFO_DICT {LANE_SEL_DICT {PROT0 {RX0 RX1 TX0 TX1} unconnected {RX2 RX3 TX2 TX3}} GT_TYPE GTM REG_CONF_INTF APB3_INTF BOARD_PARAMETER { }} \
...
RX_PAM_SEL PAM4 RX_HD_EN 2 RX_GRAY_BYP false RX_GRAY_LITTLEENDIAN false RX_PRECODE_BYP true RX_PRECODE_LITTLEENDIAN false INTERNAL_PRESET GTM-PAM4_Ethernet_106G RX_LINE_RATE 106.25 RX_PLL_TYPE LCPLL RX_REFCLK_FREQUENCY\
...
DISABLE RX_BUFFER_RESET_ON_RATE_CHANGE ENABLE RESET_SEQUENCE_INTERVAL 0 RX_COMMA_PRESET NONE RX_COMMA_VALID_ONLY 0 GT_TYPE GTM} \
    ...
    CONFIG.QUAD_USAGE {TX_QUAD_CH {TXQuad_0_/gt_quad_base {/gt_quad_base mrmac_0_exdes_support_mrmac_0_core_0_0.IP_CH0,mrmac_0_exdes_support_mrmac_0_core_0_0.IP_CH1,undef,undef MSTRCLK 1,0,0,0 IS_CURRENT_QUAD\
1}} RX_QUAD_CH {RXQuad_0_/gt_quad_base {/gt_quad_base mrmac_0_exdes_support_mrmac_0_core_0_0.IP_CH0,mrmac_0_exdes_support_mrmac_0_core_0_0.IP_CH1,undef,undef MSTRCLK 1,0,0,0 IS_CURRENT_QUAD 1}}} \
  ...
  connect_bd_net -net ch0_rxrate_1  [get_bd_pins ch0_rxrate] \
  [get_bd_pins gt_quad_base/ch0_rxrate]
  connect_bd_net -net ch0_rxusrclk_1  [get_bd_pins ch0_rxusrclk] \
  ...
  connect_bd_net -net ch0_txusrclk_1  [get_bd_pins ch0_txusrclk] \
  [get_bd_pins gt_quad_base/ch0_txusrclk]
  connect_bd_net -net ch1_loopback_1  [get_bd_pins ch1_loopback] \
  [get_bd_pins gt_quad_base/ch1_loopback]
  connect_bd_net -net ch1_rxrate_1  [get_bd_pins ch1_rxrate] \
  [get_bd_pins gt_quad_base/ch1_rxrate]
  connect_bd_net -net ch1_rxusrclk_1  [get_bd_pins ch1_rxusrclk] \
  [get_bd_pins gt_quad_base/ch1_rxusrclk]
  connect_bd_net -net ch1_txrate_1  [get_bd_pins ch1_txrate] \
  [get_bd_pins gt_quad_base/ch1_txrate]
  connect_bd_net -net ch1_txusrclk_1  [get_bd_pins ch1_txusrclk] \
  ...
  [get_bd_pins ch0_tx_usr_clk]
  connect_bd_net -net mbufg_gt_0_MBUFG_GT_O2  [get_bd_pins mbufg_gt_0/MBUFG_GT_O2] \
  [get_bd_pins ch0_tx_usr_clk2]
  connect_bd_net -net mbufg_gt_1_MBUFG_GT_O1  [get_bd_pins mbufg_gt_1/MBUFG_GT_O1] \
  [get_bd_pins ch0_rx_usr_clk]
  connect_bd_net -net mbufg_gt_1_MBUFG_GT_O2  [get_bd_pins mbufg_gt_1/MBUFG_GT_O2] \
  [get_bd_pins ch0_rx_usr_clk2]
  connect_bd_net -net mrmac_0_core_rx_clr_out_0  [get_bd_pins MBUFG_GT_CLR1] \
  [get_bd_pins mbufg_gt_1/MBUFG_GT_CLR]
  connect_bd_net -net mrmac_0_core_rx_clrb_leaf_out_0  [get_bd_pins MBUFG_GT_CLRB_LEAF1] \
  [get_bd_pins mbufg_gt_1/MBUFG_GT_CLRB_LEAF]
  connect_bd_net -net mrmac_0_core_tx_clr_out_0  [get_bd_pins MBUFG_GT_CLR] \
  [get_bd_pins mbufg_gt_0/MBUFG_GT_CLR]
  connect_bd_net -net mrmac_0_core_tx_clrb_leaf_out_0  [get_bd_pins MBUFG_GT_CLRB_LEAF] \
  ...
  set gpo_0 [ create_bd_port -dir O -from 31 -to 0 gpo_0 ]
  ...
  set_property -dict [list \
    ...
    CONFIG.FEC_SLICE0_CFG_C0 {100G (IEEE P802.3cd/D3.5 CL91) - RS(544 514)} \
    CONFIG.FEC_SLICE1_CFG_C0 {N/A} \
    CONFIG.FEC_SLICE2_CFG_C0 {N/A} \
    CONFIG.FEC_SLICE3_CFG_C0 {N/A} \
    ...
    CONFIG.MRMAC_PRESET_C0 {1x100GE 100GAUI-1 Wide} \
    CONFIG.MRMAC_SPEED_C0 {1x100GE} \
    CONFIG.NUM_GT_CHANNELS {2} \
  ...
  [get_bd_pins mrmac_0_gt_wrapper/gt_rxcdrhold]
  ...
  [get_bd_pins mrmac_0_gt_wrapper/gt_txmaincursor]
  connect_bd_net -net gt_txpostcursor_1  [get_bd_ports gt_txpostcursor] \
  [get_bd_pins mrmac_0_gt_wrapper/gt_txpostcursor]
  connect_bd_net -net gt_txprecursor_1  [get_bd_ports gt_txprecursor] \
  [get_bd_pins mrmac_0_gt_wrapper/gt_txprecursor]
  connect_bd_net -net gtpowergood_in_1  [get_bd_ports gtpowergood_in] \
  [get_bd_pins mrmac_0_core/gtpowergood_in]
  connect_bd_net -net mbufg_gt_0_MBUFG_GT_O1  [get_bd_pins mrmac_0_gt_wrapper/ch0_tx_usr_clk] \
  [get_bd_ports ch0_tx_usr_clk]
  connect_bd_net -net mbufg_gt_0_MBUFG_GT_O2  [get_bd_pins mrmac_0_gt_wrapper/ch0_tx_usr_clk2] \
  [get_bd_ports ch0_tx_usr_clk2]
  connect_bd_net -net mbufg_gt_1_MBUFG_GT_O1  [get_bd_pins mrmac_0_gt_wrapper/ch0_rx_usr_clk] \
  [get_bd_ports ch0_rx_usr_clk]
  connect_bd_net -net mbufg_gt_1_MBUFG_GT_O2  [get_bd_pins mrmac_0_gt_wrapper/ch0_rx_usr_clk2] \
  ...
  connect_bd_net -net mrmac_0_core_pm_rdy  [get_bd_pins mrmac_0_core/pm_rdy] \
  [get_bd_ports pm_rdy]
  connect_bd_net -net mrmac_0_core_rx_axis_tdata0  [get_bd_pins mrmac_0_core/rx_axis_tdata0] \
  [get_bd_ports rx_axis_tdata0]
  connect_bd_net -net mrmac_0_core_rx_axis_tdata1  [get_bd_pins mrmac_0_core/rx_axis_tdata1] \
  ...
  connect_bd_net -net mrmac_0_core_rx_axis_tdata3  [get_bd_pins mrmac_0_core/rx_axis_tdata3] \
  ...
  connect_bd_net -net mrmac_0_core_rx_axis_tdata5  [get_bd_pins mrmac_0_core/rx_axis_tdata5] \
  ...
  connect_bd_net -net mrmac_0_core_rx_axis_tkeep_user1  [get_bd_pins mrmac_0_core/rx_axis_tkeep_user1] \
  ...
  connect_bd_net -net mrmac_0_core_rx_axis_tkeep_user3  [get_bd_pins mrmac_0_core/rx_axis_tkeep_user3] \
  ...
  connect_bd_net -net mrmac_0_core_rx_axis_tkeep_user5  [get_bd_pins mrmac_0_core/rx_axis_tkeep_user5] \
  ...
  [get_bd_pins mrmac_0_gt_wrapper/MBUFG_GT_CLR1]
  ...
  [get_bd_pins mrmac_0_gt_wrapper/MBUFG_GT_CLR]
  ...
  [get_bd_pins mrmac_0_core/tx_axis_tdata1]
  ...
  [get_bd_pins mrmac_0_core/tx_axis_tdata3]
  ...
  [get_bd_pins mrmac_0_core/tx_axis_tdata5]
  ...
  [get_bd_pins mrmac_0_core/tx_axis_tkeep_user1]
  ...
  [get_bd_pins mrmac_0_core/tx_axis_tkeep_user3]
  ...
  [get_bd_pins mrmac_0_core/tx_axis_tkeep_user5]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.285467",
   "Default View_TopLeft":"-1471,7",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.8.0 2024-04-26 e1825d835c VDI=44 GEI=38 GUI=JA:21.0 TLS
#  -string -flagsOSRD
preplace port GT_Serial -pg 1 -lvl 3 -x 1080 -y 260 -defaultsOSRD
preplace port s_axi -pg 1 -lvl 0 -x 0 -y 620 -defaultsOSRD
preplace port ctl_tx_port0 -pg 1 -lvl 0 -x 0 -y 720 -defaultsOSRD
preplace port ctl_tx_port1 -pg 1 -lvl 0 -x 0 -y 740 -defaultsOSRD
preplace port ctl_tx_port2 -pg 1 -lvl 0 -x 0 -y 760 -defaultsOSRD
preplace port ctl_tx_port3 -pg 1 -lvl 0 -x 0 -y 780 -defaultsOSRD
preplace port stat_tx_port0 -pg 1 -lvl 3 -x 1080 -y 700 -defaultsOSRD
preplace port stat_tx_port1 -pg 1 -lvl 3 -x 1080 -y 720 -defaultsOSRD
preplace port stat_tx_port2 -pg 1 -lvl 3 -x 1080 -y 740 -defaultsOSRD
preplace port stat_tx_port3 -pg 1 -lvl 3 -x 1080 -y 760 -defaultsOSRD
preplace port stat_rx_port0 -pg 1 -lvl 3 -x 1080 -y 780 -defaultsOSRD
preplace port stat_rx_port1 -pg 1 -lvl 3 -x 1080 -y 800 -defaultsOSRD
preplace port stat_rx_port2 -pg 1 -lvl 3 -x 1080 -y 820 -defaultsOSRD
preplace port stat_rx_port3 -pg 1 -lvl 3 -x 1080 -y 840 -defaultsOSRD
preplace port tx_preamblein -pg 1 -lvl 0 -x 0 -y 900 -defaultsOSRD
preplace port rx_preambleout -pg 1 -lvl 3 -x 1080 -y 1000 -defaultsOSRD
preplace port APB3_INTF -pg 1 -lvl 0 -x 0 -y 60 -defaultsOSRD
preplace port port-id_apb3clk_quad -pg 1 -lvl 0 -x 0 -y 440 -defaultsOSRD
preplace port port-id_s_axi_aclk -pg 1 -lvl 0 -x 0 -y 920 -defaultsOSRD
preplace port port-id_s_axi_aresetn -pg 1 -lvl 0 -x 0 -y 940 -defaultsOSRD
preplace port port-id_gtpowergood_in -pg 1 -lvl 0 -x 0 -y 1040 -defaultsOSRD
preplace port port-id_tx_axis_tready_0 -pg 1 -lvl 3 -x 1080 -y 640 -defaultsOSRD
preplace port port-id_tx_axis_tlast_0 -pg 1 -lvl 0 -x 0 -y 660 -defaultsOSRD
preplace port port-id_tx_axis_tvalid_0 -pg 1 -lvl 0 -x 0 -y 700 -defaultsOSRD
preplace port port-id_rx_axis_tlast_0 -pg 1 -lvl 3 -x 1080 -y 660 -defaultsOSRD
preplace port port-id_rx_axis_tvalid_0 -pg 1 -lvl 3 -x 1080 -y 680 -defaultsOSRD
preplace port port-id_gtpowergood -pg 1 -lvl 3 -x 1080 -y 280 -defaultsOSRD
preplace port port-id_gt_rxcdrhold -pg 1 -lvl 0 -x 0 -y 300 -defaultsOSRD
preplace portBus ref_clk_p_0 -pg 1 -lvl 0 -x 0 -y 500 -defaultsOSRD
preplace portBus ref_clk_n_0 -pg 1 -lvl 0 -x 0 -y 520 -defaultsOSRD
preplace portBus tx_axi_clk -pg 1 -lvl 0 -x 0 -y 1520 -defaultsOSRD
preplace portBus rx_axi_clk -pg 1 -lvl 0 -x 0 -y 1100 -defaultsOSRD
preplace portBus tx_core_reset -pg 1 -lvl 0 -x 0 -y 1560 -defaultsOSRD
preplace portBus rx_core_reset -pg 1 -lvl 0 -x 0 -y 1140 -defaultsOSRD
preplace portBus tx_serdes_reset -pg 1 -lvl 0 -x 0 -y 1600 -defaultsOSRD
preplace portBus rx_serdes_reset -pg 1 -lvl 0 -x 0 -y 1220 -defaultsOSRD
preplace portBus rx_flexif_reset -pg 1 -lvl 0 -x 0 -y 1180 -defaultsOSRD
preplace portBus tx_core_clk -pg 1 -lvl 0 -x 0 -y 1540 -defaultsOSRD
preplace portBus rx_core_clk -pg 1 -lvl 0 -x 0 -y 1120 -defaultsOSRD
preplace portBus rx_serdes_clk -pg 1 -lvl 0 -x 0 -y 1200 -defaultsOSRD
preplace portBus tx_alt_serdes_clk -pg 1 -lvl 0 -x 0 -y 1260 -defaultsOSRD
preplace portBus rx_alt_serdes_clk -pg 1 -lvl 0 -x 0 -y 1080 -defaultsOSRD
preplace portBus tx_flexif_clk -pg 1 -lvl 0 -x 0 -y 1580 -defaultsOSRD
preplace portBus rx_flexif_clk -pg 1 -lvl 0 -x 0 -y 1160 -defaultsOSRD
preplace portBus tx_ts_clk -pg 1 -lvl 0 -x 0 -y 1620 -defaultsOSRD
preplace portBus rx_ts_clk -pg 1 -lvl 0 -x 0 -y 1240 -defaultsOSRD
preplace portBus pm_tick -pg 1 -lvl 0 -x 0 -y 960 -defaultsOSRD
preplace portBus gt_tx_reset_done_out -pg 1 -lvl 3 -x 1080 -y 1500 -defaultsOSRD
preplace portBus gt_rx_reset_done_out -pg 1 -lvl 3 -x 1080 -y 1520 -defaultsOSRD
preplace portBus gt_reset_all_in -pg 1 -lvl 0 -x 0 -y 980 -defaultsOSRD
preplace portBus ch0_tx_usr_clk -pg 1 -lvl 3 -x 1080 -y 360 -defaultsOSRD
preplace portBus ch0_rx_usr_clk -pg 1 -lvl 3 -x 1080 -y 400 -defaultsOSRD
preplace portBus ch0_tx_usr_clk2 -pg 1 -lvl 3 -x 1080 -y 380 -defaultsOSRD
preplace portBus ch0_rx_usr_clk2 -pg 1 -lvl 3 -x 1080 -y 420 -defaultsOSRD
preplace portBus tx_axis_tdata0 -pg 1 -lvl 0 -x 0 -y 1280 -defaultsOSRD
preplace portBus tx_axis_tdata1 -pg 1 -lvl 0 -x 0 -y 1300 -defaultsOSRD
preplace portBus tx_axis_tdata2 -pg 1 -lvl 0 -x 0 -y 1320 -defaultsOSRD
preplace portBus tx_axis_tdata3 -pg 1 -lvl 0 -x 0 -y 1340 -defaultsOSRD
preplace portBus tx_axis_tdata4 -pg 1 -lvl 0 -x 0 -y 1360 -defaultsOSRD
preplace portBus tx_axis_tdata5 -pg 1 -lvl 0 -x 0 -y 1380 -defaultsOSRD
preplace portBus tx_axis_tkeep_user0 -pg 1 -lvl 0 -x 0 -y 1400 -defaultsOSRD
preplace portBus tx_axis_tkeep_user1 -pg 1 -lvl 0 -x 0 -y 1420 -defaultsOSRD
preplace portBus tx_axis_tkeep_user2 -pg 1 -lvl 0 -x 0 -y 1440 -defaultsOSRD
preplace portBus tx_axis_tkeep_user3 -pg 1 -lvl 0 -x 0 -y 1460 -defaultsOSRD
preplace portBus tx_axis_tkeep_user4 -pg 1 -lvl 0 -x 0 -y 1480 -defaultsOSRD
preplace portBus tx_axis_tkeep_user5 -pg 1 -lvl 0 -x 0 -y 1500 -defaultsOSRD
preplace portBus rx_axis_tdata0 -pg 1 -lvl 3 -x 1080 -y 1140 -defaultsOSRD
preplace portBus rx_axis_tdata1 -pg 1 -lvl 3 -x 1080 -y 1160 -defaultsOSRD
preplace portBus rx_axis_tdata2 -pg 1 -lvl 3 -x 1080 -y 1180 -defaultsOSRD
preplace portBus rx_axis_tdata3 -pg 1 -lvl 3 -x 1080 -y 1200 -defaultsOSRD
preplace portBus rx_axis_tdata4 -pg 1 -lvl 3 -x 1080 -y 1220 -defaultsOSRD
preplace portBus rx_axis_tdata5 -pg 1 -lvl 3 -x 1080 -y 1240 -defaultsOSRD
preplace portBus rx_axis_tkeep_user0 -pg 1 -lvl 3 -x 1080 -y 1260 -defaultsOSRD
preplace portBus rx_axis_tkeep_user1 -pg 1 -lvl 3 -x 1080 -y 1280 -defaultsOSRD
preplace portBus rx_axis_tkeep_user2 -pg 1 -lvl 3 -x 1080 -y 1300 -defaultsOSRD
preplace portBus rx_axis_tkeep_user3 -pg 1 -lvl 3 -x 1080 -y 1320 -defaultsOSRD
preplace portBus rx_axis_tkeep_user4 -pg 1 -lvl 3 -x 1080 -y 1340 -defaultsOSRD
preplace portBus rx_axis_tkeep_user5 -pg 1 -lvl 3 -x 1080 -y 1360 -defaultsOSRD
preplace portBus gt_reset_tx_datapath_in -pg 1 -lvl 0 -x 0 -y 1000 -defaultsOSRD
preplace portBus gt_reset_rx_datapath_in -pg 1 -lvl 0 -x 0 -y 1020 -defaultsOSRD
preplace portBus pm_rdy -pg 1 -lvl 3 -x 1080 -y 1120 -defaultsOSRD
preplace portBus ch0_rxusrclk -pg 1 -lvl 0 -x 0 -y 340 -defaultsOSRD
preplace portBus ch0_txusrclk -pg 1 -lvl 0 -x 0 -y 240 -defaultsOSRD
preplace portBus ch1_rxusrclk -pg 1 -lvl 0 -x 0 -y 380 -defaultsOSRD
preplace portBus ch1_txusrclk -pg 1 -lvl 0 -x 0 -y 280 -defaultsOSRD
preplace portBus ch0_loopback -pg 1 -lvl 0 -x 0 -y 400 -defaultsOSRD
preplace portBus ch0_txrate -pg 1 -lvl 0 -x 0 -y 220 -defaultsOSRD
preplace portBus ch0_rxrate -pg 1 -lvl 0 -x 0 -y 320 -defaultsOSRD
preplace portBus ch1_loopback -pg 1 -lvl 0 -x 0 -y 420 -defaultsOSRD
preplace portBus ch1_txrate -pg 1 -lvl 0 -x 0 -y 260 -defaultsOSRD
preplace portBus ch1_rxrate -pg 1 -lvl 0 -x 0 -y 360 -defaultsOSRD
preplace portBus gt_txprecursor -pg 1 -lvl 0 -x 0 -y 180 -defaultsOSRD
preplace portBus gt_txpostcursor -pg 1 -lvl 0 -x 0 -y 160 -defaultsOSRD
preplace portBus gt_txmaincursor -pg 1 -lvl 0 -x 0 -y 200 -defaultsOSRD
preplace portBus gpo_0 -pg 1 -lvl 3 -x 1080 -y 300 -defaultsOSRD
preplace portBus gt_rxn_in_0 -pg 1 -lvl 0 -x 0 -y 480 -defaultsOSRD
preplace portBus gt_rxp_in_0 -pg 1 -lvl 0 -x 0 -y 460 -defaultsOSRD
preplace portBus gt_txn_out_0 -pg 1 -lvl 3 -x 1080 -y 340 -defaultsOSRD
preplace portBus gt_txp_out_0 -pg 1 -lvl 3 -x 1080 -y 320 -defaultsOSRD
preplace inst mrmac_0_core -pg 1 -lvl 1 -x 290 -y 1120 -defaultsOSRD
preplace inst mrmac_0_gt_wrapper -pg 1 -lvl 2 -x 840 -y 340 -defaultsOSRD
preplace netloc apb3clk_quad_1 1 0 2 NJ 440 NJ
preplace netloc ch0_loopback_1 1 0 2 NJ 400 NJ
preplace netloc ch0_rxrate_1 1 0 2 NJ 320 NJ
preplace netloc ch0_rxusrclk_1 1 0 2 NJ 340 NJ
preplace netloc ch0_txrate_1 1 0 2 NJ 220 NJ
preplace netloc ch0_txusrclk_1 1 0 2 NJ 240 NJ
preplace netloc ch1_loopback_1 1 0 2 NJ 420 NJ
preplace netloc ch1_rxrate_1 1 0 2 NJ 360 NJ
preplace netloc ch1_rxusrclk_1 1 0 2 NJ 380 NJ
preplace netloc ch1_txrate_1 1 0 2 NJ 260 NJ
preplace netloc ch1_txusrclk_1 1 0 2 NJ 280 NJ
preplace netloc gt_quad_base_gpo 1 2 1 NJ 300
preplace netloc gt_quad_base_gtpowergood 1 2 1 NJ 280
preplace netloc gt_quad_base_txn 1 2 1 NJ 340
preplace netloc gt_quad_base_txp 1 2 1 NJ 320
preplace netloc gt_reset_all_in_1 1 0 1 NJ 980
preplace netloc gt_reset_rx_datapath_in_1 1 0 1 NJ 1020
preplace netloc gt_reset_tx_datapath_in_1 1 0 1 NJ 1000
preplace netloc gt_rxcdrhold_1 1 0 2 NJ 300 NJ
preplace netloc gt_rxn_in_0_1 1 0 2 20J 450 630J
preplace netloc gt_rxp_in_0_1 1 0 2 30J 470 620J
preplace netloc gt_txmaincursor_1 1 0 2 NJ 200 NJ
preplace netloc gt_txpostcursor_1 1 0 2 NJ 160 NJ
preplace netloc gt_txprecursor_1 1 0 2 NJ 180 NJ
preplace netloc gtpowergood_in_1 1 0 1 NJ 1040
preplace netloc mbufg_gt_0_MBUFG_GT_O1 1 2 1 NJ 360
preplace netloc mbufg_gt_0_MBUFG_GT_O2 1 2 1 NJ 380
preplace netloc mbufg_gt_1_MBUFG_GT_O1 1 2 1 NJ 400
preplace netloc mbufg_gt_1_MBUFG_GT_O2 1 2 1 NJ 420
preplace netloc mrmac_0_core_gt_rx_reset_done_out 1 1 2 NJ 1520 NJ
preplace netloc mrmac_0_core_gt_tx_reset_done_out 1 1 2 NJ 1500 NJ
preplace netloc mrmac_0_core_pm_rdy 1 1 2 NJ 1120 NJ
preplace netloc mrmac_0_core_rx_axis_tdata0 1 1 2 NJ 1140 NJ
preplace netloc mrmac_0_core_rx_axis_tdata1 1 1 2 NJ 1160 NJ
preplace netloc mrmac_0_core_rx_axis_tdata2 1 1 2 NJ 1180 NJ
preplace netloc mrmac_0_core_rx_axis_tdata3 1 1 2 NJ 1200 NJ
preplace netloc mrmac_0_core_rx_axis_tdata4 1 1 2 NJ 1220 NJ
preplace netloc mrmac_0_core_rx_axis_tdata5 1 1 2 NJ 1240 NJ
preplace netloc mrmac_0_core_rx_axis_tkeep_user0 1 1 2 NJ 1260 NJ
preplace netloc mrmac_0_core_rx_axis_tkeep_user1 1 1 2 NJ 1280 NJ
preplace netloc mrmac_0_core_rx_axis_tkeep_user2 1 1 2 NJ 1300 NJ
preplace netloc mrmac_0_core_rx_axis_tkeep_user3 1 1 2 NJ 1320 NJ
preplace netloc mrmac_0_core_rx_axis_tkeep_user4 1 1 2 NJ 1340 NJ
preplace netloc mrmac_0_core_rx_axis_tkeep_user5 1 1 2 NJ 1360 NJ
preplace netloc mrmac_0_core_rx_axis_tlast_0 1 1 2 550J 670 1030J
preplace netloc mrmac_0_core_rx_axis_tvalid_0 1 1 2 530J 680 NJ
preplace netloc mrmac_0_core_rx_clr_out_0 1 1 1 620 560n
preplace netloc mrmac_0_core_rx_clrb_leaf_out_0 1 1 1 630 580n
preplace netloc mrmac_0_core_tx_axis_tready_0 1 0 3 70 490 560J 690 1020J
preplace netloc mrmac_0_core_tx_clr_out_0 1 1 1 600 520n
preplace netloc mrmac_0_core_tx_clrb_leaf_out_0 1 1 1 610 540n
preplace netloc pm_tick_1 1 0 1 NJ 960
preplace netloc ref_clk_n_0_1 1 0 2 60J 480 590J
preplace netloc ref_clk_p_0_1 1 0 2 NJ 500 580J
preplace netloc rx_alt_serdes_clk_1 1 0 1 NJ 1080
preplace netloc rx_axi_clk_1 1 0 1 NJ 1100
preplace netloc rx_core_clk_1 1 0 1 NJ 1120
preplace netloc rx_core_reset_1 1 0 1 NJ 1140
preplace netloc rx_flexif_clk_1 1 0 1 NJ 1160
preplace netloc rx_flexif_reset_1 1 0 1 NJ 1180
preplace netloc rx_serdes_clk_1 1 0 1 NJ 1200
preplace netloc rx_serdes_reset_1 1 0 1 NJ 1220
preplace netloc rx_ts_clk_1 1 0 1 NJ 1240
preplace netloc s_axi_aclk_1 1 0 1 NJ 920
preplace netloc s_axi_aresetn_1 1 0 2 50 460 NJ
preplace netloc tx_alt_serdes_clk_1 1 0 1 NJ 1260
preplace netloc tx_axi_clk_1 1 0 1 NJ 1520
preplace netloc tx_axis_tdata0_1 1 0 1 NJ 1280
preplace netloc tx_axis_tdata1_1 1 0 1 NJ 1300
preplace netloc tx_axis_tdata2_1 1 0 1 NJ 1320
preplace netloc tx_axis_tdata3_1 1 0 1 NJ 1340
preplace netloc tx_axis_tdata4_1 1 0 1 NJ 1360
preplace netloc tx_axis_tdata5_1 1 0 1 NJ 1380
preplace netloc tx_axis_tkeep_user0_1 1 0 1 NJ 1400
preplace netloc tx_axis_tkeep_user1_1 1 0 1 NJ 1420
preplace netloc tx_axis_tkeep_user2_1 1 0 1 NJ 1440
preplace netloc tx_axis_tkeep_user3_1 1 0 1 NJ 1460
preplace netloc tx_axis_tkeep_user4_1 1 0 1 NJ 1480
preplace netloc tx_axis_tkeep_user5_1 1 0 1 NJ 1500
preplace netloc tx_axis_tlast_0_1 1 0 1 NJ 660
preplace netloc tx_axis_tvalid_0_1 1 0 1 NJ 700
preplace netloc tx_core_clk_1 1 0 1 NJ 1540
preplace netloc tx_core_reset_1 1 0 1 NJ 1560
preplace netloc tx_flexif_clk_1 1 0 1 NJ 1580
preplace netloc tx_serdes_reset_1 1 0 1 NJ 1600
preplace netloc tx_ts_clk_1 1 0 1 NJ 1620
preplace netloc APB3_INTF_1 1 0 2 NJ 60 NJ
preplace netloc ctl_tx_port0_1 1 0 1 NJ 720
preplace netloc ctl_tx_port1_1 1 0 1 NJ 740
preplace netloc ctl_tx_port2_1 1 0 1 NJ 760
preplace netloc ctl_tx_port3_1 1 0 1 NJ 780
preplace netloc gt_quad_base_GT_Serial 1 2 1 NJ 260
preplace netloc mrmac_0_core_gtm_rx_serdes_interface_0 1 1 1 570 120n
preplace netloc mrmac_0_core_gtm_rx_serdes_interface_1 1 1 1 520 140n
preplace netloc mrmac_0_core_gtm_tx_serdes_interface_0 1 1 1 510 80n
preplace netloc mrmac_0_core_gtm_tx_serdes_interface_1 1 1 1 540 100n
preplace netloc mrmac_0_core_rx_preambleout 1 1 2 NJ 1000 NJ
preplace netloc mrmac_0_core_stat_rx_port0 1 1 2 NJ 780 NJ
preplace netloc mrmac_0_core_stat_rx_port1 1 1 2 NJ 800 NJ
preplace netloc mrmac_0_core_stat_rx_port2 1 1 2 NJ 820 NJ
preplace netloc mrmac_0_core_stat_rx_port3 1 1 2 NJ 840 NJ
preplace netloc mrmac_0_core_stat_tx_port0 1 1 2 NJ 700 NJ
preplace netloc mrmac_0_core_stat_tx_port1 1 1 2 NJ 720 NJ
preplace netloc mrmac_0_core_stat_tx_port2 1 1 2 NJ 740 NJ
preplace netloc mrmac_0_core_stat_tx_port3 1 1 2 NJ 760 NJ
preplace netloc s_axi_1 1 0 1 NJ 620
preplace netloc tx_preamblein_1 1 0 1 NJ 900
levelinfo -pg 1 0 290 840 1080
pagesize -pg 1 -db -bbox -sgen -260 0 1320 1740
"
}
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xcvp1802-lsvc4072-2MP-e-S -flow {Vivado Synthesis 2024} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xcvp1802-lsvc4072-2MP-e-S -flow {Vivado Advanced Implementation 2024} -strategy "Vivado Advanced Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
